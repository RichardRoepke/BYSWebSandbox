...
class ResHoldValidatorTest < ActiveSupport::TestCase
  ...
  test "loyalty should be valid when both text and code are both present or both absent" do
  ...
  test "discount should be valid when both text and code are both present or both absent" do
